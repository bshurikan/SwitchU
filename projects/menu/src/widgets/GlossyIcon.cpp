...
void GlossyIcon::onContentRender(nxui::Renderer& ren) {
    ...
    if (m_entryKind == GridEntryKind::Folder) {
        ...
        // Match empty-tile glass rather than an opaque white plate so names stay
        // readable and folders feel like subtle containers, not solid cards.
        ...
        // Accent slice along the top — folder identity without a busy mini-grid.
        ...
        if (named) {
            ...
            // Dark translucent band behind the label for contrast on any theme.
            ...
            // Unnamed folders keep a faint 2x2 hint so they still read as folders.
